      ...
      <div class="container d-flex flex-column flex-md-row align-items-center p-3">
        ...
        @auth
          <div class="flex-row my-3 my-md-0">
            ...
            <a href="/profile/{{ auth()->guard('web')->user()->id }}" class="mr-2"><img title="My Profile" data-toggle="tooltip" data-placement="bottom" style="width: 32px; height: 32px; border-radius: 16px" src="https://gravatar.com/avatar/f64fc44c03a8a7eb1d52502950879659?s=128" /></a>
